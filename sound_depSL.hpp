...
#define SLEC(act, func, ...)			::rs::EChk_baseA2(AAct_##act<std::runtime_error>(), SLError(), __FILE__, __PRETTY_FUNCTION__, __LINE__, func(__VA_ARGS__))
#define SLEC_M(act, obj, method, ...)	::rs::EChk_baseA2(AAct_##act<std::runtime_error>(), SLError(), __FILE__, __PRETTY_FUNCTION__, __LINE__, (*obj)->method(obj, __VA_ARGS__))
#define SLEC_M0(act, obj, method)		::rs::EChk_baseA2(AAct_##act<std::runtime_error>(), SLError(), __FILE__, __PRETTY_FUNCTION__, __LINE__, (*obj)->method(obj))
#ifdef DEBUG
